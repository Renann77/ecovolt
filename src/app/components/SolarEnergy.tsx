...
const SolarEnergySection = () => (
  <section className="flex flex-col md:flex-row items-center p-8 bg-white transition-all duration-500">

    {/* Texto com animação de fade-in */}
    <div className="md:w-1/2 space-y-4 opacity-0 transition-opacity duration-1000 delay-300 hover:opacity-100">
    ...
    <div className="relative md:w-1/2 mt-8 md:mt-0 flex justify-center hover:scale-105 transition-transform duration-500">
      ...
      {/* Botão "Tecnologia" com efeito */}
      <div className="absolute bottom-8 left-8 bg-yellow-400 p-4 rounded-md shadow-md flex items-center space-x-2 hover:scale-110 transition-transform duration-300">
